...
(0, 'Avatar', 'En el futuro, un exmarine parapléjico es enviado a la luna Pandora en una misión única que eventualmente se convierte en una épica batalla por la supervivencia.', 'James Cameron', 'Ciencia ficción', 'avatar.png', 'https://www.youtube.com/embed/CpXJHWSXJW0?si=CYAiBuTn7kGFF3pl', 0, 0),
(1, 'Forrest Gump', 'La vida de Forrest Gump, un hombre con una capacidad intelectual por debajo de la media pero con buen corazón, y su extraordinario viaje a través de la historia estadounidense.', 'Robert Zemeckis', 'Comedia', 'forrestgump.png', 'https://www.youtube.com/embed/bLvqoHBptjg?si=gjVEXAAoHT1ECIoV', 0, 0),
(2, 'The Shawshank Redemp', 'Un banquero condenado a cadena perpetua por el asesinato de su esposa y su amante, encuentra esperanza en medio de la desesperación mientras planea su escape de prisión.', 'Frank Darabont', 'Drama', 'shawshankredemption.png', 'https://www.youtube.com/embed/PLl99DlL6b4?si=uDUmWdMDvjisQ8Ly', 0, 0),
(3, 'Pulp Fiction', 'La vida de varios personajes interconectados, incluidos dos asesinos a sueldo, un boxeador, un gángster y su esposa, en tres historias entrelazadas.', 'Quentin Tarantino', 'Drama', 'pulpfiction.png', 'https://www.youtube.com/embed/s7EdQ4FqbhY?si=ujNd7lHeykVYkB2z', 0, 0),
(4, 'The Dark Knight', 'Cuando el caos irrumpe en Gotham City debido a la aparición del Joker, Batman debe enfrentarse a una de las pruebas más grandes de su vida.', 'Christopher Nolan', 'Acción', 'darkknight.png', 'https://www.youtube.com/embed/Qs-NylETt1E?si=DvuAFY9GLHyAR0QF', 0, 0),
(5, 'Fight Club', 'Un insomne empleado de oficina y un fabricante de jabón deprimido forman un club clandestino de lucha, revolucionando pronto toda la ciudad.', 'David Fincher', 'Drama', 'fightclub.png', 'https://www.youtube.com/embed/BdJKm16Co6M?si=FT_sqL2Ik9OTip7J', 0, 0),
(6, 'Inception', 'Un ladrón especializado en robar secretos del subconsciente durante el estado de sueño es contratado para implantar una idea en la mente de un CEO.', 'Christopher Nolan', 'Acción', 'inception.png', NULL, 0, 0),
(7, 'Titanic', 'Un joven aventurero y una hermosa arist&amp;oacute;crata se encuentran a bordo del infortunado RMS Titanic durante su viaje inaugura.', 'James Cameron', 'Drama', 'titanic.png', 'https://www.youtube.com/embed/tA_qMdzvCvk?si=wGMbhBcJfEXdUDMM', 0, 4),
(8, 'Barbie', 'Después de ser expulsada de Barbieland por no ser una muñeca de aspecto perfecto, Barbie parte hacia el mundo humano para encontrar la verdadera felicidad', 'Greta Gerwig', 'Comedia', 'Barbie.jpg', 'https://www.youtube.com/embed/eUP3hlBel5I?si=IEJg4XVQKfTbESHR', 0, 0),
(9, 'Gladiator', 'El general romano Máximo es el soporte más leal del emperador Marco Aurelio, que lo ha conducido de victoria en victoria. Sin embargo, Cómodo, el hijo de Marco Aurelio, está celoso del prestigio de Máximo y aún más del amor que su padre siente por él.', 'Ridley Scott', 'Acción', 'Gladiator.jpg', 'https://www.youtube.com/embed/P5ieIbInFpg?si=NbeZsbqCNLVbmCKN', 0, 0),
(10, 'El dictador', 'El Almirante Haffaz Aladeen (Baron Cohen), un dictador antioccidental, arriesga su vida con tal de evitar el establecimiento de la democracia en Wadiya, un país norteafricano con recursos petrolíferos. Su más fiel consejero es su tío Tamir (Ben Kingsley), Jefe de la Policía Secreta, Jefe de Seguridad y Proveedor de Mujeres. Por desgracia para Aladeen y sus consejeros, Occidente ha empezado a inmiscuirse en los asuntos de Wadiya, país que ha sido sancionado varias veces por las Naciones Unidas en la última década. Tras sufrir un atentado que le cuesta la vida a uno de sus consejeros, Tamir convence a Aladeen para que vaya a Nueva York a solucionar la cuestión en la ONU', 'Sacha Baron-Cohen', 'Comedia', 'El dictador.jpg', 'https://www.youtube.com/embed/opqLwNj0428?si=Tss0_6DnloibNwsb', 0, 0),
(11, 'Los increibles', 'Un súper héroe retirado lucha contra el aburrimiento en un suburbio y junto con su familia tiene la oportunidad de salvar al mundo.', 'Brad Bird', 'Animación', 'Los increibles.jpeg', '//www.youtube.com/embed/6-Vql6wlW7o?si=SoFxkLB-mrwXRpvl', 0, 0),
(12, 'Cars', 'El aspirante a campeón de carreras Rayo McQueen parece que está a punto de conseguir el éxito. Su actitud arrogante se desvanece cuando llega a una pequeña comunidad olvidada que le enseña las cosas importantes de la vida que había olvidado.', 'John Lasseter', 'Animación', 'Cars.jpg', '//www.youtube.com/embed/W_H7_tDHFE8?si=4-Tfsveidv3qXoex', 0, 5),
(13, 'Gran Torino', 'Walt Kowalski, un veterano de la guerra de Corea, es un obrero jubilado del sector del automóvil que ha enviudado recientemente. Su máxima pasión es cuidar de su más preciado tesoro: un coche Gran Torino de 1972', 'Clint Eastwood', 'Acción', 'Gran Torino.jpg', '//www.youtube.com/embed/RMhbr2XQblk?si=x82aS_3FoX5qLVs3', 0, 0),
(14, 'Shrek', 'Hace mucho tiempo, en una lejana ciénaga, vivía un ogro llamado Shrek. Un día, su preciada soledad se ve interrumpida por un montón de personajes de cuento de hadas que invaden su casa. Todos fueron desterrados de su reino por el malvado Lord Farquaad.', 'Andrew Adamson', 'Animación', 'Shrek.jpg', '//www.youtube.com/embed/B88JfTyJ1Fw?si=_YXlKG1DSve3yboI', 0, 0),
(15, 'Interstellar', 'Un astronauta viaja en el tiempo para salvar la humanidad del cierre de un agujero negro.', 'Christopher Nolan', 'Ciencia ficción', 'interstellar.jpg', 'https://www.youtube.com/embed/OiLv76dNj4w?si=90Q_FGv-1t6XjV6i', 0, 0),
(16, 'Moana', 'Una joven chica de Hawái parte en un peregrinaje para rescatar a su padre y restaurar el poder de la deidad de la vida.', 'Ron Huerta', 'Animación', 'moana.jpg', 'https://www.youtube.com/embed/Xn383YBdC78?si=D2L0w9pXL76Ox9YX', 0, 0),
(17, 'Spotlight', 'Un equipo de periodistas de Boston descubre un escándalo de abusos sexual cometidos por clérigos católicos y lucha contra la corrupción para denunciarlo.', 'Tom McCarthy', 'Drama', 'spotlight.jpg', 'https://www.youtube.com/embed/wWq3TUvKxQA?si=_0L5sE3Gj4mNm7Uf', 0, 0),
(19, 'La La Land', 'Un músico de jazz y una bailarina de ballet se enamoran mientras trabajan juntos en una producción cinematográfica.', 'James Bill', 'Drama', 'lala-land.jpg', 'https://www.youtube.com/embed/v3y-zO6N1lQ?si=jvY_3jJ2_9-_tU-Q', 0, 0),
(20, 'The Revenant', 'Un hombre sobreviviente de un masacro en el siglo XIX, que lleva a cabo una travesía peligrosa y perilosa para encontrar a su hermano que también sobrevivió.', 'Alejandro G. Iddia', 'Acción', 'revenant.jpg', 'https://www.youtube.com/embed/QZJ9rCxz_j0?si=dNs5Qq5lFmS-VVrG', 0, 0),
(21, 'The Big Short', 'Tras el desastre bursátil de 2008, un hombre sin trabajo y un experto en juegos de azar se unen para detener a los banqueros y los traders que llevaron al mundo a la quiebra.', 'Adam McKay', 'Documental', 'big-short.jpg', 'https://www.youtube.com/embed/9OZvWsh3zWI?si=O7kxMj9yK6yK-b7T', 0, 0),
(22, 'La danza de los vientos', 'Un joven hombre es desposado en una aldea de villanos y debe demostrar su valía para sobrevivir en un mundo de guerras y traiciones.', 'Ang Lee', 'Animación', 'dance-of-the-winds.jpg', 'https://www.youtube.com/embed/m-bT_4j1S3Q?si=9h5nJ_rN_9-_tU-Q', 0, 0),
(23, 'Sicario: Otra vida', 'Un hombre de la CIA, que lleva una vida en la que asesina a gente sin cuestionar, debe enfrentarse a su pasado cuando es traído de regreso a la acción.', 'Denis Villeneuve', 'Acción', 'sicario2.jpg', 'https://www.youtube.com/embed/_o9FzEhO0Wg?si=V6F59_Q4K9-_tU-Q', 0, 0),
(24, '12 Hombres Sin Línea', 'Un hombre, desesperado por la muerte de su mujer, se une a un equipo de mercenarios para llevar a cabo una misión peligrosa en el Congo.', 'Kenneth Renker', 'Acción', '12-hombres.jpg', 'https://www.youtube.com/embed/dQWlN4-nfZw?si=BQyIUQ3JL928GZgW', 0, 0),
(25, 'Black Panther', 'En el universo de Wakanda, T’Challa, el rey de Wakanda, lucha por mantener su reino y su gente en paz, mientras se enfrenta a las amenazas externas y内部.', 'Ryan Coogler', 'Acción/Ficción/Ciencia ficción', 'blackpanther.png', 'https://www.youtube.com/embed/OvzG9vU4pW8?si=O1f4K9MfF9-_tU-Q', 0, 0),
(26, 'Joker', 'Un hombre en el borde de la locura, que comete un asesinato después de otro y lleva a cabo una serie de crímenes en Nueva York.', 'Todd Phillips', 'Terror', 'joker.png', 'https://www.youtube.com/embed/r8r-Gy0PWuw?si=S-ZrLHY1J9-_tU-Q', 0, 0),
(27, 'Parasitos', 'Una familia de obreros migratorios se encuentra en medio de una lucha económica para ganar el suficiente dinero para pagar una operación quirúrgica que les permitirá a su hija nacer.', 'Bong Joon-ho', 'Terror/Drama', 'parasitos.png', 'https://www.youtube.com/embed/xE_q-VrW6F0?si=BQyIUQ3JL928GZgW', 0, 0),
(28, 'Crazy Rich Asians', 'Una mujer estadounidense se casa con un hombre rico y exclusivo, pero pronto descubre que su nuevo marido vive en un mundo de lujo y extravagancia.', 'Jon M. Chu', 'Romance/Drama', 'crazyrichasians.png', 'https://www.youtube.com/embed/a-FhY6Vm0Bg?si=S-ZrLHY1J928GZgW', 0, 0),
(29, 'The Lighthouse', 'Dos hombres de diferentes épocas y lugares, que viven en un islote remoto, se encuentran y comienzan a descubrir verdades sobre su pasado y sobre ellos mismos.', 'Robert Eggers', 'Drama/Ficción/Historia', 'thelighthouse.jpg', 'https://www.youtube.com/embed/M_z7YUW80HM?si=lG2GnTf9F9-_tU-Q', 0, 0),
(30, 'Midsommar', 'Una mujer y su hija se dirigen a Suecia para pasar las fiestas de San Juan, pero pronto descubren que los antiguos mitos y leyendas de esa tierra serán la realidad.', 'Wilson y Alexander', 'Terror/Ficción/Terror psicológico', 'midsommar.jpg', 'https://www.youtube.com/embed/Z_yRv7B4RsU?si=41lJ28mf9-_tU-Q', 0, 0),
(31, 'First Man', 'La historia de Neil Armstrong y los primeros pasos humanos en el espacio.', 'Ryan Coogler', 'Drama/Biografía/Ficción', 'firstman.jpg', 'https://www.youtube.com/embed/RP6B9b9hj_o?si=22lH_f3pF9-_tU-Q', 0, 0),
(32, 'The Irishman', 'La historia de las últimas horas de Scarface, Don Vito Andolini, y cómo terminó su vida.', 'Martin Scorsese', 'Terror/Crime/Drama', 'theirishman.jpg', 'https://www.youtube.com/embed/XQ-f26ZLdAw?si=22lH_f3pF9-_tU-Q', 0, 0),
(33, 'The King''s Man', 'Los hombres que salvan el mundo deberán enfrentarse a un mundo que se encuentra en crisis.', 'Todd Phillips', 'Acción/Ciencia ficción', 'thekingsman.jpg', 'https://www.youtube.com/embed/rKy8QrVh-OE?si=22lH_f3pF9-_tU-Q', 0, 0),
(34, 'The Tragedy of Macbeth', 'La historia de Macbeth, un hombre que comete un asesinato y se enfrenta a la conciencia.', 'Sofia Coppola', 'Terror/Ficción', 'thetragedyofmacbeth.jpg', 'https://www.youtube.com/embed/bXQAjBXGn_A?si=Jjf4xjJpF9-_tU-Q', 0, 0),
(35, 'The White Princess', 'La historia de una mujer que se encuentra en medio de la Guerra de las Rosas y debe descubrir lo que es amor verdadero.', 'Joan Chombhaut', 'Drama/Ficción/Historia', 'thewhiteprincess.jpg', 'https://www.youtube.com/embed/Z_yRv7B4RsU?si=41lJ28mf9-_tU-Q', 0, 0);
